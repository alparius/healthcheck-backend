...
import healthcheck.application.dto.AcceptProposalResponseDto;
import healthcheck.application.dto.ActivityDto;
import healthcheck.application.dto.ProposalDto;
import healthcheck.application.dto.ProposalLocationDto;
import healthcheck.application.mapper.ActivityDtoMapper;
import healthcheck.application.mapper.ProposalDtoMapper;
import healthcheck.application.mapper.ProposalLocationDtoMapper;
import healthcheck.application.model.Proposal;
import healthcheck.application.service.LoginService;
import healthcheck.application.service.ProposalService;
...
public class ProposalController {
    ...
    @RequestMapping(
            ...
            value = {UserController.LEADER_ENDPOINT + "/acceptProposal"},
            produces = {"application/json"},
            method = {RequestMethod.POST}
    )
    ...
    @RequestMapping(
            ...
            value = {UserController.LEADER_ENDPOINT + "/rejectProposal"},
            produces = {"application/json"},
            method = {RequestMethod.POST}
    )
