...
INSERT INTO User(username, password, email, phone, firstName, surname, isAdmin) VALUES
          ('leader1', '1234', 'leader1@gmail.com', '0720321456', 'firstName', 'surname',true);

INSERT INTO User(username, password, email, phone, firstName, surname, isAdmin)  VALUES
          ('moisit', '1234', 'moisit@gmail.com', '0720321458', 'Teofana', 'Moisi',false);
...
INSERT INTO Activity(description, category, title, status, startDateAndTime, endDateAndTime, userid) VALUES
('description1', 'games', 'title1', 'IN_PROGRESS', '2020-07-25 12:17:55','2020-07-25 14:00:00', 1),
('description2', 'games', 'title2', 'IN_PROGRESS', '2020-07-25 14:17:55','2020-07-25 16:00:00', 1);
